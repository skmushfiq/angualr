...
export const reducer = createReducer(
   ...
   */
  on(
    TeamsApiActions.searchSuccess,
    TeamListApiActions.loadTeamsSuccess,
    (state, { teams }) => adapter.addMany(teams, state)
  ),
  /**
   ...
   */
  on(TeamActions.loadTeam, (state, { team }) => adapter.addOne(team, state)),
  on(ViewTeamPageActions.selectTeam, (state, { id }) => ({
    ...state,
    selectedTeamId: id,
  }))
);
